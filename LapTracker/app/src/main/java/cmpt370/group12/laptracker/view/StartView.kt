            ...
            if (viewModel.createRace.value) {
                ...
                Card(
                    ...
                    Column(
                        ...
                        // Check services and permissions before allowing user to start tracking
                        if (!viewModel.locationClient.servicesEnabled() || !viewModel.locationClient.hasLocationPermissions()) {
                            Icon(
