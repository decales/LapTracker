...
interface LapTrackerRepository {
    ...
    suspend fun Achievement_insert(achievement: Achievement): Long
    ...
    suspend fun Comment_insert(comment: Comment): Long
    ...
    suspend fun RunTimes_insert(runtimes: Runtimes) : Long
    ...
    fun Runs_getByTrackIdFlow(trackId: Int): Flow<List<Runs>>
